```L2-Switch-Config
hostname MP-L2SW-02 !!FILL IN HERE
!
...
line console 0
 logging synchronous
!
banner motd @ Welcome to the MP-L2SW-02, lets make the MAJTeQ happen! @
!
...
interface Vlan50
 ...
 ip address 10.110.50.6 255.255.255.0
 no shut
!
...
!
int g0/1
 description MP-L2SW-02 / G0/1 to MP-L3SW-01 / G1/0/8 - Client Trunk
 switchport mode trunk
 switchport trunk encapsulation dot1q
 switchport trunk native vlan 999
!
int g0/2
 description MP-L2SW-02 / G0/2 to MP-L3SW-02 / G1/0/7 - Client Trunk
 switchport mode trunk
 switchport trunk encapsulation dot1q
 switchport trunk native vlan 999
! 
