...
L3-Switch-Config
```
hostname MP-L3SW-02 !!FILL IN HERE
!
...
spanning-tree vlan 10,12,20,30,40,50,60,70,80,90,100,110,120,130,140,150,400,666,999 root secondary
!
...
!
!
banner motd @ Welcome to the MP-L3SW-02, lets make the MAJTeQ happen! @
!
...
! name Management
int vlan 50
 ip address 10.110.50.4 255.255.255.0 !PLACEHOLDER CHANGE IP
...
interface GigabitEthernet0/10
 description MP-L3SW-02 / G0/10-12 to Admin Workstations / VMNet 2 IT Access
...
interface GigabitEthernet0/13
 description MP-L3SW-02 / G0/13-15 to Admin Workstations / VMNet 1 NetworkManagement
 switchport access vlan 50
 switchport mode access
 no shut
!
